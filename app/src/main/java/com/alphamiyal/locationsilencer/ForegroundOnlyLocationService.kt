    ...
    override fun onCreate() {
        ...
        locationCallback = object : LocationCallback(){
            override fun onLocationResult(locationResult: LocationResult) {
                ...
                // Fix with LiveData
                // Observer is attached here when Livedata is returned, but the
                // value in livedata has not been recieved yet
                // Observer code will run when livedata gets value back
